...
export const Header = () => {
  ...
  function multipleStates(isOpen, isOpenSecond){
    setIsOpen(isOpen)
      ...
      <div className="header__menu-drop">
       ...
       <div className='header__wrapper'>
        ...
        <ul className="header__menu">
          <li><button  onClick={() => multipleStates(!isOpen, false)}>STORE</button></li>
          <li><button  onClick={() => multipleStates(false, !isOpenSecond)}>CREATE</button></li>
          <li>MY DESIGN</li>
          <li>FAQ</li>
        </ul>
