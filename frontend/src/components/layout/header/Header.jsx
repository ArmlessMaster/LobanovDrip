    ...
    <div className='header' ref={ref}>
      <div className="header__menu-drop">
        <motion.div className="header__menu-drop__item first"
          ...
          <ul>
            <p><NavLink to="/store">NEW DROPS</NavLink></p>
            <p>DISCONT</p>
            <li><NavLink to="/store/T-Shirt">T-STORE</NavLink></li>
        ...
        <motion.div className="header__menu-drop__item card"
          ...
          <div className="header__menu-drop__item-flex grid">
            ...
            cartHeader?.clothes.map((cart, index) => {
              return (<ItemModule class="search" text={cart.name} price={cart.totalPrice + "₴"} link={`/store/${cart?.name.split(' ')[0]}/${cart.clothes_id}`} key={cart._id} img={cart.image} sizes={cart.size} />)
            }) 
            : isLocalStorage && isEmptyCart && !auth.token ? 
          ...
          isEmptyCart ?
            (<div className="header__menu-accept">
              ...
              <NavLink to="/cart">
                <PixelBtn text="OPEN CART" color="RedLittle" />
              </NavLink>
              </div>
              <div className="price">
                <div className="price-label">{!isLocalStorage ? "TOTAL PRICE: " + cartHeader.total + "₴" :  "TOTAL PRICE: " +  totalSum(JSON.parse(localStorage.getItem("cart") || "[]")) + "₴"}</div>
                <div className="low-text">INCLUDING VAT</div>
              </div>
            </div>)
            :
        ...
        <motion.div className="header__menu-drop__item account"
          ...
          <div className="header__menu-drop__item-account-wrapper">
            ...
            <div className="header__menu-drop__item-account">
              <div>
                <NavLink to="/auth">
                  <BlackBtn text="LOGIN" class="little" onClick={handleSetOpen} />
                </NavLink>
              </div>
            </div>
            <div className="header__menu-drop__item-account">
              ...
              <div className="header__menu-drop__item-account_little-text">
                After registration, you will deny access to rich functions and additional features.
              </div>
            </div>
            <div className="header__menu-drop__item-account">
              <div>
                <NavLink to="/auth">
                  <BlackBtn text="REGISTER" class="little" onClick={handleSetOpen} />
                </NavLink>
              </div>
            </div>
          </div>
      ...
      <div className='header__wrapper'>
        ...
        <ul className="header__menu">
          <li><button onClick={() => multipleStates(!isOpen, false, false, false, false)}>STORE</button></li>
          <li><button onClick={() => multipleStates(false, !isOpenSecond, false, false, false)}>CREATE</button></li>
          <li>MY DESIGN</li>
          <li>FAQ</li>
        </ul>
        <div className="header__search">
          <form>
            <input onChange={handleOnChange} onClick={() => multipleStates(false, false, true, false, false)} type="text" placeholder="SEARCH" name="search" />
          </form>
        </div>
      ...
      <motion.div className="header__menu-drop__item account"
        ...
        <div className="header__menu-drop__item-account-wrapper">
          ...
          <div className="header__menu-drop__item-account">
            <div>
              <NavLink to="/auth">
                <BlackBtn text="ABABA" class="little" onClick={handleSetOpen} />
              </NavLink>
            </div>
          </div>
          <div className="header__menu-drop__item-account">
