...
export default function PersonalInfo({navigation}) {
    ...
    const changeInfoHandler = async () => {
        try{
            const method = "PUT";
            let body = {_id: getId(auth.token), email: email, name: name, surname: surname, patronymic: patronymic, phone: (phone.startsWith("+38") ? phone.slice(3) : phone)};
        ...
        } catch(e) {console.log("Info was not changed. Error!")}
    }
                ...
                <View style={styles.main}>
                    <ScrollView style={{flex :1}}>
                        ...
                        <View style={styles.greyBotton}>
                            <TextInput
                                style={[styles.greyBottonText, {backgroundColor:'#1F1F1F', width:'70%', height:'200%', justifyContent:'center', alignItems: 'center'}]}
                                value={name}
                        ...
                        <View style={styles.redBotton}>
                            <Pressable onPress={changeInfoHandler} style={{backgroundColor:'#DB2525', width:'50%', height:'200%', justifyContent:'center', alignItems: 'center'}}>
                        ...
                        <View style={{flexDirection:'row', flex:10}}>
                            ...
                            <View style={styles.redBotton2}>
                                <Pressable onPress={changeDeliveryInfo} style={{backgroundColor:'#DB2525', width:'65%', height:'200%', justifyContent:'center', alignItems: 'center'}}>
                                    <Text style={styles.greyBottonText}>CHANGE</Text>
                                </Pressable>
                            </View>
                        </View>
